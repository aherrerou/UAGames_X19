<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Compras.aspx.cs" Inherits="web.Compras" %><asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
...
"></asp:SqlDataSource>
    ...
    <canvas id="barChart" runat="server" width="400" height="400"></canvas>
<script>
    ...
    var data = {
        labels: ["Adrian", "Clara", "Omar", "Aitor"], // Obtén los datos de Usuario desde la fuente de datos
        datasets: [{
